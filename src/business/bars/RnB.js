...
const Rnb = ({ id, geo }) => (
	<Panel id={id}>
		...
		<Group
			...
			header={<Header>Те самые бургеры</Header>}>
			<Div>
				"Rock N Burger" обладает чуть ли не единственными в городе,
				действительно классными бургерами. Это отличное заведение, чтобы
				холодным вечером зайти в бар, заказать бургер с пивом, и просто
				наслаждаться.
				<br />
				Помимо бургеров, Вы можете отведать пиццу и напитки собственного
				приготовления, салаты, а также изумительную картошку-фри, которая точно
				западёт Вам в душу и заставит заказать ещё одну порцию. По секрету:
				берите картошку с паприкой :)
				<br /> <br />
				Заинтересовались?
				<br />
		...
		<Div style={{ paddingBottom: 0 }}>
			<Cell
				...
				description='12:00 - 23:00 (Пт - до 02:00)'>
				Мелик-Карамова, 4/4
			</Cell>
			<Cell
				size='l'
			...
			<Cell
				size='l'
				href='https://instagram.com/rockburger_bar'
				target='_blank'
		...
		<Group
			...
			<YMaps>
				<Map
					defaultState={{ center: [61.234229, 73.438707], zoom: 17 }}
					width='90vw'
					height='60vh'>
					<Placemark
						defaultGeometry={[61.234229, 73.438707]}
