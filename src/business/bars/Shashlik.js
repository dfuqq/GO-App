...
const Off = ({ id, geo }) => (
	<Panel id={id}>
		...
		<Group
			...
			header={<Header>Райский гриль</Header>}>
			<Div>
				Вкуснейшее мясо, доступное каждому.
				<br />
				Это "ШашлыкoFF" — заведение, что за малую сумму доставит Вам огромное
				удовольствие. Демократичность, хорошая кухня и отличное обслуживание
				сильно выделяют это заведение, ведь где ещё можно отведать вкусный и
				недорогой шашлык, кроме как не здесь?
				<br />
				Кроме шашлыка, тут подают отличные супы и бургеры, а также стейки. Всё
				готовится из охлаждённого мяса, ведь именно в нём сохраняется больше
				всего витаминов и полезных для организма веществ.
				<br /> <br />
		...
		<Div style={{ paddingBottom: 0 }}>
			<Cell
				...
				description='11:00 - 01:00 (Пт, Сб - до 03:00)'>
				Профсоюзов, 11
				<br />
				Ленина 50/1
			</Cell>
			...
			<Cell size='l' before={<Icon28PhoneOutline height={24} width={24} />}>
				94-56-00 (Профсоюзов 11)
				<br />
				93-74-79 (Ленина 50/1)
			</Cell>
			<Cell
				size='l'
				href='https://instagram.com/shashlikoff_surgut'
				target='_blank'
		...
		<Group
			...
			<YMaps>
				<Map
					defaultState={{ center: [61.262673, 73.385365], zoom: 13 }}
					width='90vw'
					height='60vh'>
					<Placemark
						defaultGeometry={[61.269424, 73.382403]}
						defaultOptions={{ preset: 'islands#circleIcon', iconColor: '#000' }}
					/>
					<Placemark
						defaultGeometry={[61.255827, 73.388001]}
						defaultOptions={{ preset: 'islands#circleIcon', iconColor: '#000' }}
					/>
					{geo[0] !== undefined && (
						<Fragment>
