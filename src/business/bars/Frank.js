...
const Frank = ({ id, geo }) => (
	<Panel id={id}>
		...
		<Group
			...
			header={<Header>Идеальное свидание</Header>}>
			<Div>
				Пользователи массово характеризуют "Frank Bar & Kitchen" как лучшее
				место для свиданий!
				<br />
				И честно говоря, мы придерживаемся этого мнения. Огромный выбор
				различных вин, хорошая кухня с пиццой, бургерами, салатами и мясными
				порциями — всё это отметит каждый, кто хоть раз побывает в этом
				заведении.
				<br />
				Большим плюсом можно выделить отличный дизайн и высококлассный персонал,
				которые оставляют приятное впечатление от визита.
				<br /> <br />
		...
		<Div style={{ paddingBottom: 0 }}>
			<Cell
				...
				description='12:00 - 23:00 (Пт, Сб - до 02:00)'>
				Мелик-Карамова, 4/4
			</Cell>
			<Cell
				size='l'
			...
			<Cell
				size='l'
				href='https://instagram.com/frankbarwine'
				target='_blank'
		...
		<Group
			...
			<YMaps>
				<Map
					defaultState={{ center: [61.234299, 73.438364], zoom: 17 }}
					width='90vw'
					height='60vh'>
					<Placemark
						defaultGeometry={[61.234299, 73.438364]}
