...
const Dpub = ({ id, geo }) => (
	<Panel id={id}>
		...
		<Group
			...
			header={<Header>Вперёд в прошлое</Header>}>
			<Div>
				Паб, каким он и должен быть.
				<br />
				Лишь только Вы входите в заведение, как вдруг перед Вами меняются эпохи:
				из современного Сургута Вы перемещаетесь в Нью-Йорк 50-60х годов и
				проникаетесь этим.
				<br />
				К счастью, еда тут постоянно свежая и очень вкусная. Многообразие
				закусок к пенному, блюда на гриле и бургеры, а самое главное — широкий
				выбор пива — всё это не оставит Вас голодным и равнодушным.
				<br /> <br />
		...
		<Div style={{ paddingBottom: 0 }}>
			...
			<Cell
				size='l'
				href='https://instagram.com/thedockpub'
				target='_blank'
		...
		<Group
			...
			<YMaps>
				<Map
					defaultState={{ center: [61.246867, 73.417275], zoom: 17 }}
					width='90vw'
					height='60vh'>
					<Placemark
						defaultGeometry={[61.246867, 73.417275]}
