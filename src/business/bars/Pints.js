...
const Pints = ({ id, geo }) => (
	<Panel id={id}>
		...
		<Group
			...
			header={<Header>Двух не хватит</Header>}>
			<Div>
				Прямиком из заграницы — теперь в Сургуте.
				<br />
				"Две Пинты" имеет в своём арсенале всё, чтобы влюбить в себя клиента.
				<br />
				Например, море пива из разных уголков мира, которое не оставит
				равнодушным даже искушённого гостя. Вкусные закуски, отличная кухня и
				приятная атмосфера, которые выливаются в одно — желание приходить снова
				и снова.
				<br /> <br />
		...
		<Div style={{ paddingBottom: 0 }}>
			<Cell
				...
				description='17:00 - 22:00 (Пт, Сб - до 02:00)'>
				Ленина, 39
			</Cell>
			<Cell
				size='l'
			...
			<Cell
				size='l'
				href='https://instagram.com/two.pint.bar.surgut'
				target='_blank'
		...
		<Group
			...
			<YMaps>
				<Map
					defaultState={{ center: [61.254515, 73.387993], zoom: 17 }}
					width='90vw'
					height='60vh'>
					<Placemark
						defaultGeometry={[61.254515, 73.387993]}
