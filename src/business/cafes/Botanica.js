...
const Botanica = ({ id, geo }) => (
	<Panel id={id}>
		...
		<Group
			...
			header={<Header>Самая вкусная наука</Header>}>
			<Div>
		...
		<Div style={{ paddingBottom: 0 }}>
			...
			<Cell
				size='l'
				href='https://instagram.com/botanicacafe'
				target='_blank'
		...
		<Group
			...
			<YMaps>
				<Map
					defaultState={{ center: [61.240119, 73.404912], zoom: 17 }}
					width='90vw'
					height='60vh'>
					<Placemark
						defaultGeometry={[61.240119, 73.404912]}
