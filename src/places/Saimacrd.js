	...
	return (
		<Panel id={id}>
			...
			<Group style={{ padding: '0 5vw' }}>
				...
				<br />
				<br />
				Общая площадь более 65 га. На территории находятся спортивные площадки и
				скейтпарк, набережная с лежаками, а также множество скамеек и детских
				площадок.
				<br />В начале 90-х годов был необустроен. В 2000 году на территории
				было решено разместить ботанический сад, однако проект пока не был
				реализован. Позднее, в 2013 году, появился план по обустройству парка, а
				в 2020 году начались первые работы по реконструкции.
			</Group>
			...
			<Group
				...
				<YMaps>
					<Map
						defaultState={{ center: [61.24455, 73.427265], zoom: 15 }}
						width='90vw'
						height='60vh'>
						<Placemark
							defaultGeometry={[61.24455, 73.427265]}
							defaultOptions={{
