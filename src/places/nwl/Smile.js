    ...
    return (
        <Panel id={props.id}>
            ...
            <Gallery
                ...
                bullets="light"
            >
                <img style={{ objectFit: 'contain' }} src="https://sun9-25.userapi.com/NpWM36yQm3nMN1QqUTqmHQSkV7fvGNZfXuri-Q/AHbVC3FyT-I.jpg" alt="Smile"/>
                <img style={{ objectFit: 'contain' }} src="https://sun9-7.userapi.com/vg7gqGxYnYerpc7TB8a_gi7SsVmRfYRlAGk5-Q/yMQeMSuq04c.jpg" alt="Smile"/>
            </Gallery>
            ...
            <Group separator='hide' style={{ paddingBottom: '12px' }}>
                <Cell size='l' before={<Icon28PlaceOutline width={24} height={24} />}>30 Лет Победы, 21/2</Cell>
            </Group>

            <Group style={{ display: 'flex', justifyContent: 'center', paddingBottom: '12px' }}>
                <YMaps>
                    <Map defaultState={{ center: [61.253531, 73.422938], zoom: 17 }} width='90vw' height='60vh'>
                        <Placemark defaultGeometry={[61.253531, 73.422938]} defaultOptions={{preset: 'islands#blueObservationCircleIcon', iconColor: '#000'}} />
