	...
	return (
		<Panel id={id}>
			...
			<Group style={{ padding: '0 5vw' }}>
				...
				<br />
				<br />В здании разместились Сургутский краеведческий и художественный
				музеи. Каждый готов показать посетителю богатую историю города и округа,
				а современные системы, такие как "Виртуальный музей" и "Интерактивная
				карта", помогут увидеть все экспонаты музея без затруднений.
			</Group>
			...
			<Group separator='hide' style={{ paddingBottom: '12px' }}>
				...
				<Cell
					size='l'
					before={<Icon24Link />}
					href='https://skmuseum.ru/museum-center'
					target='_blank'>
					skmuseum.ru
				</Cell>
			</Group>
			...
			<Group
				...
				<YMaps>
					<Map
						defaultState={{ center: [61.253837, 73.423099], zoom: 17 }}
						width='90vw'
						height='60vh'>
						<Placemark
							defaultGeometry={[61.253837, 73.423099]}
							defaultOptions={{
