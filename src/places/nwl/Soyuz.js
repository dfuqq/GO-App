...
const Soyuz = ({ id, geo, go }) => {
	return (
		<Panel id={id}>
			<PanelHeader
				left={
					<PanelHeaderBack onClick={go} data-to='places'></PanelHeaderBack>
				}>
				ТЦ "Союз"
			</PanelHeader>
			...
			<Group separator='hide' style={{ paddingBottom: '12px' }}>
				...
				<Cell
					...
					href='https://instagram.com/soyuz_surgut'
					target='_blank'>
					@soyuz_surgut
				</Cell>
			</Group>
			...
			<Group
				...
				<YMaps>
					<Map
						defaultState={{ center: [61.254182, 73.433559], zoom: 17 }}
						width='90vw'
						height='60vh'>
						<Placemark
							defaultGeometry={[61.254182, 73.433559]}
							defaultOptions={{
