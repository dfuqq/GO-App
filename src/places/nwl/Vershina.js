	...
	return (
		<Panel id={id}>
			...
			<Group style={{ padding: '0 5vw' }}>
				...
				<br />
				<br />
				Расположен в северо-восточной части города, содержит в себе множество
				магазинов и кафе. Примечателен футуристичный дизайн ТЦ, который
			...
			<Group
				...
				<YMaps>
					<Map
						defaultState={{ center: [61.256666, 73.431499], zoom: 17 }}
						width='90vw'
						height='60vh'>
						<Placemark
							defaultGeometry={[61.256666, 73.431499]}
							defaultOptions={{
