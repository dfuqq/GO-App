    ...
    return (
        <Panel id={props.id}>
            ...
            <Gallery
                ...
                align = "center"
            >
                <img style={{ objectFit: 'contain' }} src="https://sun9-13.userapi.com/zO6-rRTi7QOu9sjy8VdBhGIGuRWdpFlC_JavGw/q5JPOqcvamU.jpg" alt="Tsgu"/>
            </Gallery>
            ...
            <Group separator='hide' style={{ paddingBottom: '12px' }}>
                ...
                <Cell size='l' before={<Icon24Link />} href="https://kassa-ugra.ru/venue/64" target="_blank">Афиша</Cell>
