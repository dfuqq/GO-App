    ...
    return (
        <Panel id={props.id}>
            ...
            <Gallery
                ...
                align = "center"
            >
                <img style={{ objectFit: 'contain' }} src="https://sun9-16.userapi.com/feqL3kYXtUKYm00cOax0t2kMifBo0EzkhQxj8g/T7Qlp7yZsl4.jpg" alt="Rib"/>
            </Gallery>
            ...
            <Group style={{ display: 'flex', justifyContent: 'center', paddingBottom: '12px' }}>
                <YMaps>
                    <Map defaultState={{ center: [61.230852, 73.468635], zoom: 17 }} width='90vw' height='60vh'>
                        <Placemark defaultGeometry={[61.230852, 73.468635]} defaultOptions={{preset: 'islands#blueObservationCircleIcon', iconColor: '#000'}} />
