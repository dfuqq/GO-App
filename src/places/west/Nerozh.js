	...
	return (
		<Panel id={id}>
			...
			<Group style={{ padding: '0 5vw' }}>
				...
				<br />
				<br />
				Установлен в 2013 году на территории храма в честь великомученника
				Георгия Победоносца, при центре помощи семье и детям.
				<br />
				Интересны материалы: бедная мать, выполненная из гранита, олицетворяет
				собой физическое тело, в то время, как дочь из прозрачной смолы — душа
				ребёнка.
			</Group>
			...
			<Group
				...
				<YMaps>
					<Map
						defaultState={{ center: [61.247696, 73.427176], zoom: 17 }}
						width='90vw'
						height='60vh'>
						<Placemark
							defaultGeometry={[61.247696, 73.427176]}
							defaultOptions={{
