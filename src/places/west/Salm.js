	...
	return (
		<Panel id={id}>
			...
			<Group style={{ padding: '0 5vw' }}>
				...
				<br />
				<br />
				Открыт в сентябре 2007 года в честь 50-летия высадки первых
				геологоразведчиков в Сургут.
				<br />
				На территории мемориального комплекса расположен дом с личными вещами
				Салманова, а снаружи находится техника для нефтеразработки и образцы
				проб горных пород и нефти.
			</Group>
			...
			<Group separator='hide' style={{ paddingBottom: '12px' }}>
				...
				<Cell
					size='l'
					before={<Icon24Link />}
					href='https://skmuseum.ru/salmanov'
					target='_blank'>
					skmuseum.ru
				</Cell>
			</Group>
			...
			<Group
				...
				<YMaps>
					<Map
						defaultState={{ center: [61.240783, 73.475595], zoom: 17 }}
						width='90vw'
						height='60vh'>
						<Placemark
							defaultGeometry={[61.240783, 73.475595]}
							defaultOptions={{
