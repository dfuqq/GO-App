    ...
    return (
        <Panel id={props.id}>
            ...
            <Gallery
                ...
                bullets="light"
            >
                <img style={{ objectFit: 'contain' }} src="https://sun9-27.userapi.com/jRyN5CiSNi7AKxVTiMt9CeiCBCOPE5UZOKkp4g/WY1dYbPE1OY.jpg" alt="Ssurcrd"/>
                <img style={{ objectFit: 'contain' }} src="https://sun9-71.userapi.com/WVR_GGf64TrxhEfUyy2G1JBj1SeF0nXfT_vt8g/Ga-bH3ZWtv0.jpg" alt="Ssurcrd"/>
                <img style={{ objectFit: 'contain' }} src="https://sun9-61.userapi.com/07c9v9INr5v1Css8O6v2V1DEXiGAIL7eW58Ofg/JfDP9qXl0OI.jpg" alt="Ssurcrd"/>
                <img style={{ objectFit: 'contain' }} src="https://sun9-22.userapi.com/SvorgI52GqgzgBAPUJv9T0nGB0jUJUMz_ZaPIA/3uzVXFNO30A.jpg" alt="Ssurcrd"/>
            </Gallery>
